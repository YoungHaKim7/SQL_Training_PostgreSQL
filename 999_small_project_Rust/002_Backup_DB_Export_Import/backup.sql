...
\restrict YEX8dW3EyTxoidzLiD4UTUgTa8UotBwfzqMhgo3FrFAaoqc3jTesSqKcHTfx7rd
...
--
-- Name: customers; Type: TABLE; Schema: public; Owner: gy
--
...
ALTER TABLE public.customers OWNER TO gy;

--
-- Name: customers_id_seq; Type: SEQUENCE; Schema: public; Owner: gy
--
...
ALTER SEQUENCE public.customers_id_seq OWNER TO gy;

--
-- Name: customers_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: gy
--
...
--
-- Name: customers id; Type: DEFAULT; Schema: public; Owner: gy
--
...
--
-- Data for Name: customers; Type: TABLE DATA; Schema: public; Owner: gy
--

COPY public.customers (id, customer_id, first_name, last_name, company, city, country, phone1, phone2, email, subscription_date, website) FROM stdin;
...
--
-- Name: customers_id_seq; Type: SEQUENCE SET; Schema: public; Owner: gy
--
...
--
-- Name: customers customers_pkey; Type: CONSTRAINT; Schema: public; Owner: gy
--
...
\unrestrict YEX8dW3EyTxoidzLiD4UTUgTa8UotBwfzqMhgo3FrFAaoqc3jTesSqKcHTfx7rd
